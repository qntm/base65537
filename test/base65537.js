...
console.log('demo')
console.log(base65537.encode(Buffer.from('d41d8cd98f00b204e9800998ecf8f11f', 'hex')) === '䯕傺檸𥴏髌𡎱𦸜💩')
console.log(base65537.decode('䯕傺檸𥴏髌𡎱𦸜💩').equals(Buffer.from('d41d8cd98f00b204e9800998ecf8f11f', 'hex')))
console.log()
